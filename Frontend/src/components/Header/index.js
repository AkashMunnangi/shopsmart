    ...
    return (
        <div>
            {isAdmin ?
                ...
                <Navbar fixed="top" style={{ padding: '0 20px', minHeight: '10vh', width: '100%',backgroundColor: "lightblue" }} expand="lg" >
                    <Navbar.Brand><Link to='/' style={{ textDecoration: 'none' }}>Insta-Mart</Link></Navbar.Brand>
                    <Navbar.Toggle aria-controls="navbarSupportedContent" />    
                    <Navbar.Collapse id="navbarSupportedContent">
                        <Nav className="mr-auto">
